...
const InventoryBox = inject('gameplayStore')(
	observer(({ loginStore, gameplayStore, inventory, getinventory, match }) => {
		return inventory ? (
			<div className="inventory">
				<div>
					...
					{loginStore.profile.itembool[parseInt(match.params.id)] &&
					!gameplayStore.potionUsed ? (
						gameplayStore.inventory ? (
							<div className="inventory-items">
								{gameplayStore.inventory.some(obj => obj.elixir === 0) ? (
								...
								{gameplayStore.inventory.some(obj => obj.elixir === 1) ? (
									<div className="inventory-item">
										<div className="crystal">
											<YellowCrystal />
										</div>
										<div className="inventory-item-content">
											<div>RegionMultiplier</div>
											<button
												onClick={() => {
													gameplayStore.useRegionMultiplier();
													loginStore.getProfile();
												}}
											>
												USE
								...
								{gameplayStore.inventory.some(obj => obj.elixir === 2) ? (
									<div className="inventory-item">
										<div className="crystal">
											<PurpleCrystal />
										</div>
								...
								{gameplayStore.inventory.some(obj => obj.elixir === 3) ? (
									<div className="inventory-item">
										<div className="crystal">
											<RedCrystal />
										</div>
	...
	observer(({ gameplayStore, match }) => (
		<div className="QuestionBox">
			...
			<div className="AnswerWrapper">
				...
				<button onClick={() => gameplayStore.submit(match.params.id)}>
					SUBMIT
				</button>
				...
				<div className="stats">
					{attempts ? (
						...
						<>
							...
							<span className="Hint">
								Leading: {gameplayStore.stats.leading}
							</span>
							<span className="Hint">
								Trailing: {gameplayStore.stats.trailing}
							</span>
						</>
					)}
				</div>
